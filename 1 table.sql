...
create table dbo.House(
    ...
    DateSold date null constraint c_House_date_sold_must_be_before_current_date check(DateSold < getdate()),
    AskingPrice decimal(9,2) null,
    SellingPrice decimal(9,2) null constraint c_House_selling_price_must_be_between_100000_and_9999999 check(SellingPrice between 100000 and 9999999),
    InContract bit null, 
