...
select      'Chaim Green', 'Lakewood', '01/04/2022', 'Strawberry shortcake', 'Cake', 'none', 0,  'Please make sure they both look the same', 'Baby', 2
...
union select 'Devorah Friedman', 'Brooklyn', '07/04/2021', 'Strawberry shortcake', 'Cake', 'none', 0, 'none', 'Wedding', 15
union select 'Kaufman', 'Lakewood', '11/09/2021', 'Chocolate peanut butter', 'Cake', 'Chocolate', 0, 'none', 'Bar mitzvah', 3
union select 'Chana Cohen', 'Lakewood', '07/04/2021', 'Banana', 'Cake', 'Vanilla',1, 'Attached photo', 'Anniversary', 1
union select 'Ahuva Licht', 'Lakewood', '06/22/2021', 'Sugar', 'Cookie', 'Royal icing', 0, 'Write Chaim and Devorah', 'Engagement', 75
union select 'Tziporah Markowitz', 'Lakewood', '03/16/2021', 'Strawberry shortcake', 'Cake', 'none', 0, 'none', 'Baby', 3
...
union select 'Rachel Bernstein', 'Lakewood', '02/28/2021', 'Sugar', 'Cookie', 'Fondant', 1, 'Attached photo of daughter', 'Bas mitzvah', 80
