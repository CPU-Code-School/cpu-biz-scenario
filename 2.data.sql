...
insert Sales(CustomerFirstName, CustomerLastName, CostumesBought, CostumeSize, Quantity, PriceSoldPerCostume, DateBought, DateSold)
select 'Chana', 'Goldberg', 'Artist', 'XS', 2, 20, '2020-02-14', '2020-04-02'
...
union select 'Bracha', 'Ganz', 'Princess', 'M', 4, 25, '2020-11-3', '2021-12-12'
union select 'Yaakov', 'Cohen', 'Princess', 'XS', 1, 20, '2021-12-4', '2022-07-25'
