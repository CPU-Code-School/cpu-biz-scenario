...
select 'Chaim Green', 'Lakewood', '01/04/2022', 'Strawberry shortcake', 'Cake', 'no topping', 'no',  'Please make sure they both look the same', 'Baby', 2
...
union select 'Chana Cohen', 'Lakewood', '07/04/2021', 'Banana', 'Cake', 'Royal icing', 'yes', 'Attached photo', 'Anniversary', 1
