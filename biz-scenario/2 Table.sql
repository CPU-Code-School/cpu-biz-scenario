...
CREATE TABLE dbo.Army(
    ...
    SSN char (10) not null
        ...
        CONSTRAINT c_Army_SSN_must_have_8_numbers_then_a_dash_then_another_number CHECK  (ssn like'[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]-[0-9]'),
    ...
    IQ INT not NULL
        CONSTRAINT c_Army_IQ_can_only_be_up_to_144 CHECK(IQ between 0 and 144),
